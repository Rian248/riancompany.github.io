...
if(isset($_POST['simpan'])){
    ...
    if($password != ''){ //jika kana melakukan perubahan pasword
        ...
        if($password_lama == '' or $konfirmasi_password == '' or $password == ''){
            $err    .= "<li>Silahkan masukkan password lama, password baru serta konfirmasi password baru</li>";
        }
        ...
        if(strlen($password) < 6){
            $err    .= "<li>Panjang karakter yang diizinkan untuk password adalah minimal 6 karakter</li>";
        }
    }
