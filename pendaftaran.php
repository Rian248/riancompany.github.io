...
if(isset($_POST['simpan'])){
    ...
    //cek di bagian db, apakah email suddah ada atau belum.
    if($email != ''){
    ...
    if(empty($err)){
        ...
        $isi_email          .= url_dasar()."/verivikasi.php?email=$email&kode=$status";
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                ...
                <br><br>
                Login sebagai <a href='<?php echo url_dasar()?>/admin/login.php'>admin</a>
            </td>
        </tr>
        <tr>
            <td>
