    ...
    <tbody>
        ...
        while ($r1 = mysqli_fetch_array($q1)) {
            ...
            <tr>
                ...
                <td>
                    <img src="../gambar/<?php echo partners_foto($r1['id']) ?>" style="max-height:100px;max-width:100px"/>
                </td>
                <td>
                    <?php echo $r1['nama'] ?>
                </td>
                <td>
                    ...
                    <a href="partners.php?op=delete&id=<?php echo $r1['id']?>" onclick="return confirm('Ingin hapus data?')">
