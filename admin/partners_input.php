...
if (isset($_POST['simpan'])) {
    ...
    if ($nama == '' or $isi == '') {
        $error = "Silahkan masukkan semua data yaitu data nama dan isi.";
    }
    //print_r($_FILES);
    if($_FILES['foto']['name']){
        ...
        $ekstensi_yang_diperbolehkan = array("jpg","JPG","JPEG","jpeg","png","gif");
...
?>
<h1>Halaman Admin Input Data Input Partners</h1>
<div class="mb-3 row">
